...
(cl:defmethod cl:initialize-instance :after ((m <Complex>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Complex)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tester-msg:<Complex> is deprecated: use tester-msg:Complex instead.")))

(cl:ensure-generic-function 'real-val :lambda-list '(m))
(cl:defmethod real-val ((m <Complex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tester-msg:real-val is deprecated.  Use tester-msg:real instead.")
  (real m))

(cl:ensure-generic-function 'imaginary-val :lambda-list '(m))
(cl:defmethod imaginary-val ((m <Complex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tester-msg:imaginary-val is deprecated.  Use tester-msg:imaginary instead.")
  (imaginary m))
