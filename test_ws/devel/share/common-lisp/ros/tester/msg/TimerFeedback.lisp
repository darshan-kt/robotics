...
(cl:defmethod cl:initialize-instance :after ((m <TimerFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TimerFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tester-msg:<TimerFeedback> is deprecated: use tester-msg:TimerFeedback instead.")))

(cl:ensure-generic-function 'time_elapsed-val :lambda-list '(m))
(cl:defmethod time_elapsed-val ((m <TimerFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tester-msg:time_elapsed-val is deprecated.  Use tester-msg:time_elapsed instead.")
  (time_elapsed m))

(cl:ensure-generic-function 'time_remaining-val :lambda-list '(m))
(cl:defmethod time_remaining-val ((m <TimerFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tester-msg:time_remaining-val is deprecated.  Use tester-msg:time_remaining instead.")
  (time_remaining m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TimerFeedback>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#3. feedback sent by server periodically~%# the amout of time has elapsed from start (frequent update time)~%duration time_elapsed~%# the amount of time remaining untill we're done~%duration time_remaining~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TimerFeedback)))
  "Returns full string definition for message of type 'TimerFeedback"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#3. feedback sent by server periodically~%# the amout of time has elapsed from start (frequent update time)~%duration time_elapsed~%# the amount of time remaining untill we're done~%duration time_remaining~%~%~%"))
